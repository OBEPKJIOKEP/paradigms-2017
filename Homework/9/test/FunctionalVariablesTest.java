...
public class FunctionalVariablesTest extends FunctionalExpressionTest {
    public static class VariablesTests extends ArithmeticTests {
        protected final AbstractExpression vu = variable("u", 3);
        protected final AbstractExpression vv = variable("v", 4);
        protected final AbstractExpression vw = variable("w", 5);
